...
- **Global scope**: `/Users/muhammadbilalmirza/Claude/PMG/guideflow-project_MBM/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/muhammadbilalmirza/Claude/PMG/guideflow-project_MBM/.claude/notes/`)
...
2. Glob `/Users/muhammadbilalmirza/Claude/PMG/guideflow-project_MBM/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/muhammadbilalmirza/Claude/PMG/guideflow-project_MBM/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/muhammadbilalmirza/Claude/PMG/guideflow-project_MBM/.claude/notes/` — works in any directory
