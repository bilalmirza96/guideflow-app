...
- Usage: Reference from command with `@/Users/muhammadbilalmirza/Claude/PMG/guideflow-project_MBM/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/muhammadbilalmirza/Claude/PMG/guideflow-project_MBM/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/muhammadbilalmirza/Claude/PMG/guideflow-project_MBM/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
